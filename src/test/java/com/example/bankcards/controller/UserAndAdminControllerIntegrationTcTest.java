...
public class UserAndAdminControllerIntegrationTcTest {
    ...
    void userEndpoint_WithValidUserToken_ReturnsOk() throws Exception {
        ...
        CardCreationRequest requestBody = new CardCreationRequest(101L, "1111222233334444", "2028-12-31");
        ...
        mockMvc.perform(get("/api/v1/user/cards")
                ...
                .andExpect(jsonPath("$.content[0].maskedCardNumber").value("**** **** **** 4444"))
